...
public class GetPublicCourseDetailResponseDto {
    ...
    public static GetPublicCourseDetailResponseDto of(Long id, String nickname, int level, String userImage, Boolean isNowUser,
                                                      Long publicCourseId, Long courseId, Boolean isScrap, Integer scrapCount,
        ...
        return new GetPublicCourseDetailResponseDto(
                GetPublicCourseDetailResponseDto.GetPublicCourseDetailUser.from(id, nickname, level, userImage, isNowUser),
    ...
    public static class GetPublicCourseDetailUser {
        ...
        public static GetPublicCourseDetailResponseDto.GetPublicCourseDetailUser from(Long id, String nickname, int level,
                                                                                      String image, Boolean isNowUser) {
            return new GetPublicCourseDetailResponseDto.GetPublicCourseDetailUser(id, nickname, level, image, isNowUser);
        }
    }
    ...
    public static class GetPublicCourseDetailPublicCourse {
        ...
        public static GetPublicCourseDetailResponseDto.GetPublicCourseDetailPublicCourse from(Long publicCourseId, Long courseId,
                                                                                              Boolean scrap, Integer scrapCount,
